...
export function WhatsAppFloatButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-teal-700 text-white shadow-lg transition-transform hover:scale-105 hover:bg-teal-800 focus-visible:scale-105 sm:bottom-6 sm:right-6"
    >
